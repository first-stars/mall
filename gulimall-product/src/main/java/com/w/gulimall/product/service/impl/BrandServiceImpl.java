...
import com.w.gulimall.product.dao.BrandDao;
...
public class BrandServiceImpl extends ServiceImpl<BrandDao, BrandEntity> implements BrandService {
    ...
    @Override
    public List<BrandEntity> getBrandIdsById(List<Long> brandIds) {
        List<BrandEntity> brandEntityList = baseMapper.selectList(new QueryWrapper<BrandEntity>().in("bran_id", brandIds));
